    ...
    class f {
      ...
      static getIntegration(e) {
        return Object(o.a)(this, void 0, void 0, function* () {
          if (c.a.useSafariLegacyPush()) return a.a.Secure;
  ...
  function (e, t, i) {
    ...
    class c {
      ...
      static useSafariVapidPush() {
        return r.a.safari && a() && !this.useSafariLegacyPush();
      }
      static version() {
        return Number(151600);
      }
  ...
  function (e, t, i) {
    ...
    class a extends s.a {
      ...
      serialize() {
        ...
        return (
          this.subscription &&
            ((e.identifier = r.a.useSafariLegacyPush()
      ...
      static createFromPushSubscription(e, t, i) {
        ...
        return (
          (n.appId = e),
          (n.subscriptionState = t ? o.a.Subscribed : o.a.NotSubscribed),
  ...
  function (e, t, i) {
    ...
    class d {
      ...
      getDeliveryPlatform() {
        ...
        return s.a.useSafariLegacyPush()
          ? a.a.SafariLegacy
          : s.a.useSafariVapidPush()
          ? a.a.SafariVapid
          : e.firefox
          ? a.a.Firefox
          : e.msedge
  ...
  function (e, t, i) {
    ...
    class l {
      ...
      getReportedNotificationPermission(e) {
        return Object(c.a)(this, void 0, void 0, function* () {
          if (u.a.useSafariLegacyPush())
            return l.getSafariNotificationPermission(e);
    ...
    class h {
      ...
      static getLocalPageViewCount() {
        return Number(localStorage.getItem(f));
      }
    }
    class b {
      constructor() {
      ...
      getPageViewCount() {
        try {
          const e = sessionStorage.getItem(b.SESSION_STORAGE_KEY_NAME),
            t = e ? parseInt(e) : 0;
          return isNaN(t) ? 0 : t;
        } catch (e) {
          return 0;
      ...
      setPageViewCount(e) {
        try {
          sessionStorage.setItem(b.SESSION_STORAGE_KEY_NAME, e.toString()),
            s.a.getWindowEnv() === r.a.OneSignalSubscriptionPopup &&
      ...
      getLocalPageViewCount() {
        return h.getLocalPageViewCount();
      }
      setLocalPageViewCount(e) {
        h.setLocalPageViewCount(e);
      }
    }
    b.SESSION_STORAGE_KEY_NAME = "onesignal-pageview-count";
    class v {
      constructor(e) {
        if (!e)
          throw new InvalidArgumentError.a(
    ...
    class x {
      ...
      getRegistration() {
        return Object(c.a)(this, void 0, void 0, function* () {
          return yield E.a.getRegistration(
      ...
      getActiveState() {
        return Object(c.a)(this, void 0, void 0, function* () {
          ...
          if (e === S.a.InsecureProxy) return k.a.Indeterminate;
          if (e === S.a.SecureProxy) {
        ...
        if ("akam-sw.js" == n) {
          ...
          if (e)
            return (
              ...
              new v(new URL(e).pathname).getFileName()
            );
        }
        return n;
      }
      ...
      shouldInstallWorker() {
        return Object(c.a)(this, void 0, void 0, function* () {
          if (!u.a.supportsServiceWorkers()) return !1;
      ...
      haveParamsChanged() {
        return Object(c.a)(this, void 0, void 0, function* () {
          ...
          const n = E.a.getAvailableServiceWorker(e),
            o = k.b.getServiceWorkerHref(
              this.config,
      ...
      workerNeedsUpdate() {
        return Object(c.a)(this, void 0, void 0, function* () {
          ...
          try {
            e = yield C.a.timeoutPromise(this.getWorkerVersion(), 2e3);
          } catch (e) {
            return (
              a.a.info(
          ...
          return e !== u.a.version()
            ? (a.a.info(
                `[Service Worker Update] Updating service worker from ${e} --\x3e ${u.a.version()}.`
              ),
              !0)
            : (a.a.info(
          ...
          e.off(),
            e.on(o.b.NotificationDisplayed, (e) =>
              Object(c.a)(this, void 0, void 0, function* () {
                a.a.debug(
                  ...
                  yield O.a.trigger(OneSignal.EVENTS.NOTIFICATION_DISPLAYED, e);
              })
            ),
            e.on(o.b.NotificationClicked, (e) =>
              Object(c.a)(this, void 0, void 0, function* () {
                ...
                } else yield O.a.trigger(OneSignal.EVENTS.NOTIFICATION_CLICKED, e);
              })
            ),
            ...
            e.on(o.b.NotificationDismissed, (e) =>
              Object(c.a)(this, void 0, void 0, function* () {
                yield O.a.trigger(OneSignal.EVENTS.NOTIFICATION_DISMISSED, e);
              })
            );
          const t = d.b.isHttps(),
            i = d.b.isSafari();
      ...
      installWorker() {
        return Object(c.a)(this, void 0, void 0, function* () {
          ...
          a.a.info("Installing worker..."),
            (yield this.getActiveState()) === k.a.ThirdParty &&
              a.a.info(
                "[Service Worker Installation] 3rd party service worker detected."
              );
          const e = k.b.getServiceWorkerHref(
              this.config,
              this.context.appConfig.appId,
              u.a.version()
            ),
    ...
    !(function (e) {
      ...
      ((T = A || (A = {}))[(T.MissingAppId = 0)] = "MissingAppId"),
      (T[(T.RedundantPermissionMessage = 1)] = "RedundantPermissionMessage"),
      (T[(T.PushPermissionAlreadyGranted = 2)] =
        "PushPermissionAlreadyGranted"),
      (T[(T.UnsupportedEnvironment = 3)] = "UnsupportedEnvironment"),
      (T[(T.MissingDomElement = 4)] = "MissingDomElement"),
      (T[(T.ServiceWorkerNotActivated = 5)] = "ServiceWorkerNotActivated"),
      (T[(T.NoProxyFrame = 6)] = "NoProxyFrame");
    class V extends w.a {
      constructor(e, t) {
        let i;
        switch (e) {
          ...
          case A.UnsupportedEnvironment:
            ...
            break;
          case A.ServiceWorkerNotActivated:
    ...
    ((_ = M || (M = {}))[(_.Blocked = 0)] = "Blocked"),
      (_[(_.Dismissed = 1)] = "Dismissed"),
      (_[(_.Default = 2)] = "Default");
    class B extends w.a {
      constructor(e) {
        let t;
        switch (e) {
        ...
        super(t), (this.reason = e), Object.setPrototypeOf(this, B.prototype);
      }
    }
    var L,
      H,
    ...
    class K {
        ...
        return Object(c.a)(this, void 0, void 0, function* () {
          ...
          switch (t) {
            ...
            case r.a.OneSignalProxyFrame:
              throw new V(A.UnsupportedEnvironment);
          }
          let i;
          switch (t) {
        ...
        return Object(c.a)(this, void 0, void 0, function* () {
          ...
          return (
            ...
            s.a.getWindowEnv() !== r.a.ServiceWorker &&
              O.a.trigger(OneSignal.EVENTS.REGISTERED),
            "undefined" != typeof OneSignal &&
      ...
      unsubscribe(e) {
        return Object(c.a)(this, void 0, void 0, function* () {
          if (0 === e) throw new y.a();
          if (1 !== e) throw new y.a();
          if (s.a.getWindowEnv() !== r.a.ServiceWorker) throw new y.a();
          {
            ...
            yield U.a.updatePlayer(this.context.appConfig.appId, e, {
              ...
              yield m.a.put("Options", { key: "optedOut", value: !0 });
          }
        });
      }
      ...
      subscribeSafari() {
        return Object(c.a)(this, void 0, void 0, function* () {
          ...
          (e.existingSafariDeviceToken = t),
            t || O.a.trigger(OneSignal.EVENTS.PERMISSION_PROMPT_DISPLAYED);
      ...
      subscribeFcmFromPage(e) {
        return Object(c.a)(this, void 0, void 0, function* () {
          if (
            ...
            yield O.a.trigger(OneSignal.EVENTS.PERMISSION_PROMPT_DISPLAYED);
      ...
      subscribeFcmFromWorker(e) {
        return Object(c.a)(this, void 0, void 0, function* () {
          ...
          if (!t.active && !D.a.firefox)
            throw new V(A.ServiceWorkerNotActivated);
          const i = yield t.pushManager.permissionState({
            userVisibleOnly: !0,
          });
          if ("denied" === i) throw new B(M.Blocked);
          if ("prompt" === i) throw new B(M.Default);
          return yield this.subscribeWithVapidKey(t.pushManager, e);
        });
      }
      getVapidKeyForBrowser() {
        let e = void 0;
        return (e = D.a.firefox
          ...
          switch (e) {
            ...
            case S.a.SecureProxy:
              if (t === r.a.Host) {
                ...
                throw new V(A.NoProxyFrame);
              }
              return yield this.isSubscriptionExpiringForSecureIntegration();
            case S.a.InsecureProxy:
    ...
    var G = class {
        static getServiceWorkerManager(e) {
          const t = e.appConfig,
            ...
            n = {
              workerPath: new v(`/${i}OneSignalSDKWorker.js`),
    ...
    class ee {
      ...
      static isPushEnabled() {
        return h.getIsPushNotificationsEnabled();
      }
      static isOptedOut() {
        return h.getIsOptedOut();
      }
    }
    class te {
      ...
      static checkAndTriggerSubscriptionChanged() {
        return Object(c.a)(this, void 0, void 0, function* () {
          ...
          (null === n || t !== n) &&
            ...
            h.setIsPushNotificationsEnabled(t),
      ...
      static onSubscriptionChanged_showWelcomeNotification(e) {
        return Object(c.a)(this, void 0, void 0, function* () {
          if (OneSignal.__doNotShowWelcomeNotification)
            ...
            const { deviceId: e } = yield m.a.getSubscription(),
              { appId: t } = yield m.a.getAppConfig(),
            ...
            (o = Y.a.decodeHtmlEntities(o)),
              ...
              n ||
                ...
                O.a.trigger(OneSignal.EVENTS.WELCOME_NOTIFICATION_SENT, {
                  title: o,
                  message: s,
                  url: c,
                }));
      ...
      static triggerSubscriptionChanged(e) {
        O.a.trigger(OneSignal.EVENTS.SUBSCRIPTION_CHANGED, e);
      }
        ...
        return Object(c.a)(this, void 0, void 0, function* () {
          function t(e) {
            return Object(c.a)(this, void 0, void 0, function* () {
              ...
              (t.clickedNotifications[e.url] = null), yield m.a.setAppState(t);
              const { data: i, timestamp: n } = e;
              if (n) {
                if ((Date.now() - n) / 1e3 / 60 > 5) return;
              }
              O.a.trigger(OneSignal.EVENTS.NOTIFICATION_CLICKED, i);
            });
          }
          const i = yield m.a.getAppState();
          if (
            "origin" ===
            (yield m.a.get("Options", "notificationClickHandlerMatch"))
          ) {
    ...
    class oe {
      static registerForPush() {
        return Object(c.a)(this, void 0, void 0, function* () {
          const e = h.getIsPushNotificationsEnabled();
          ...
          switch (s.a.getWindowEnv()) {
            ...
            default:
              throw (
                ("undefined" != typeof OneSignal &&
                  (OneSignal._isRegisteringForPush = !1),
                new V(A.UnsupportedEnvironment))
              );
          }
          return (
            "undefined" != typeof OneSignal &&
    ...
    class se {
      ...
      static getNotificationIcons() {
        return Object(c.a)(this, void 0, void 0, function* () {
          ...
          if (!e) throw new V(A.MissingAppId);
      ...
      static getSlidedownOptions(e) {
        return C.a.getValueOrDefault(e.slidedown, { prompts: [] });
      }
      ...
      static triggerCustomPromptClicked(e) {
        O.a.trigger(OneSignal.EVENTS.CUSTOM_PROMPT_CLICKED, { result: e });
      }
      static getAppId() {
        return Object(c.a)(this, void 0, void 0, function* () {
    ...
    class ae {
      ...
      sendExternalUserIdUpdate(e, t) {
        return Object(c.a)(this, void 0, void 0, function* () {
          ...
          const i = {
            external_user_id: C.b.getValueOrDefault(e, ""),
            external_user_id_auth_hash: C.b.getValueOrDefault(t, void 0),
          };
    ...
    class ue {
      constructor(e) {
        (this.appConfig = e),
          ...
          (this.pageViewManager = new b()),
          (this.sessionManager = new ce(this)),
          (this.permissionManager = new l()),
